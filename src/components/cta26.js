                  ...
                  {props.content1 ?? (
                    <Fragment>
                      <span className="cta26-text5">
                        Browse our collection of trading view indicators, price
                        action concepts, and oscillator matrix to take your
              ...
              <div className="cta26-actions">
                ...
                >
                  <span>
                    {props.action1 ?? (
                      <Fragment>
                        <span className="cta26-text6">Explore Indicators</span>
                      </Fragment>
                    )}
                  </span>
                </button>
