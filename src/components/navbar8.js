        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text15">#indicators</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text14">#about</span>
                </Fragment>
              )}
            </a>
            <div
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text18">Explore Now</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text17">
                                  Explore a variety of price action concepts and
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text16">Indicators</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  page4ImageSrc:
    'https://images.unsplash.com/photo-1694470400242-fdae8cd64355?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDg1MTQ3Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  page1ImageAlt: 'Home Image',
  linkUrlPage1: 'https://www.teleporthq.io',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1706720097405-dba39b683e51?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDg1MTQ3M3w&ixlib=rb-4.0.3&q=80&w=1080',
  link3: undefined,
  logoSrc:
  ...
  page2ImageAlt: 'Indicators Image',
  logoAlt: 'Trading View Indicators',
  link2Url: 'https://www.teleporthq.io',
  linkUrlPage2: 'https://www.teleporthq.io',
  action1: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1486041954898-e85670abcc91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDg1MTQ3M3w&ixlib=rb-4.0.3&q=80&w=1080',
  page3: undefined,
  link1: undefined,
  ...
  link4: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1595450547833-95af46d7c43a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDg1MTQ3Mnw&ixlib=rb-4.0.3&q=80&w=1080',
